...
class DualXtecEq1FxParams(MixerNode):
    ...
    a_gain = LinearFloatProperty("02", -12.0, 12.0, decimals=1, grid_size=49, units='dB')
    a_low_boost = LinearFloatProperty("03", 0.0, 10.0, decimals=1, grid_size=101)
    a_low_frequency = EnumIntProperty("04", ALowFrequencyOptions)
    a_low_attenuation = LinearFloatProperty("05", 0.0, 10.0, decimals=1, grid_size=101)
    a_high_bandwidth = LinearFloatProperty("06", 0.0, 10.0, decimals=1, grid_size=101)
    a_high_boost = LinearFloatProperty("07", 0.0, 10.0, decimals=1, grid_size=101)
    a_high_frequency = EnumIntProperty("08", AHighFrequencyOptions)
    a_high_attenuation = LinearFloatProperty("09", 0.0, 10.0, decimals=1, grid_size=101)
    a_attenuation_selector = EnumIntProperty("10", AAttenuationSelectorOptions)
    a_transfer = BoolProperty("11")
    b_on = BoolProperty("12")
    b_gain = LinearFloatProperty("13", -12.0, 12.0, decimals=1, grid_size=49, units='dB')
    b_low_boost = LinearFloatProperty("14", 0.0, 10.0, decimals=1, grid_size=101)
    b_low_frequency = EnumIntProperty("15", BLowFrequencyOptions)
    b_low_attenuation = LinearFloatProperty("16", 0.0, 10.0, decimals=1, grid_size=101)
    b_high_bandwidth = LinearFloatProperty("17", 0.0, 10.0, decimals=1, grid_size=101)
    b_high_boost = LinearFloatProperty("18", 0.0, 10.0, decimals=1, grid_size=101)
    b_high_frequency = EnumIntProperty("19", BHighFrequencyOptions)
    b_high_attenuation = LinearFloatProperty("20", 0.0, 10.0, decimals=1, grid_size=101)
