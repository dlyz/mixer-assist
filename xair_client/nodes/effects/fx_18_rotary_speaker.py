...
class RotarySpeakerFxParams(MixerNode):
    ...
    low_speed = LogFloatProperty("01", 0.1, 4.0, decimals=2, grid_size=101, units='Hz')
    high_speed = LogFloatProperty("02", 2.0, 10.0, decimals=2, grid_size=101, units='Hz')
    acceleration = LinearFloatProperty("03", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    distance = LinearFloatProperty("04", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    balance = LinearFloatProperty("05", -100.0, 100.0, decimals=0, grid_size=41, units='%')
