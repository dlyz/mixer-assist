...
class RhythmDelayFxParams(MixerNode):
    ...
    feed = LinearFloatProperty("03", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    ...
    spread = LinearFloatProperty("06", 0.0, 6.0, decimals=0, grid_size=7)
    ...
    gain_b = LinearFloatProperty("10", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    factor_c = EnumIntProperty("11", FactorCOptions)
    gain_c = LinearFloatProperty("12", 0.0, 100.0, decimals=0, grid_size=51, units='%')
