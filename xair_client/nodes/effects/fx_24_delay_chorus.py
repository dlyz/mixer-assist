...
class DelayChorusFxParams(MixerNode):
    ...
    chorus_speed = LogFloatProperty("07", 0.05, 4.0, decimals=2, units='Hz')
    chorus_depth = LinearFloatProperty("08", 0.0, 100.0, decimals=0, units='%')
    chorus_delay = LogFloatProperty("09", 0.5, 50.0, decimals=1, units='ms')
    chorus_phase = LinearFloatProperty("10", 0.0, 180.0, decimals=0, units='°')
    chorus_wave = LinearFloatProperty("11", 0.0, 100.0, decimals=0, units='%')
