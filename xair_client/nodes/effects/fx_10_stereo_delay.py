...
class StereoDelayFxParams(MixerNode):
    ...
    mix = LinearFloatProperty("01", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    time = LinearFloatProperty("02", 1.0, 3000.0, decimals=0, grid_size=3000, units='ms')
    mode = EnumIntProperty("03", ModeOptions)
    factor_l = EnumIntProperty("04", FactorLOptions)
    factor_r = EnumIntProperty("05", FactorROptions)
    offset_lr = LinearFloatProperty("06", -100.0, 100.0, decimals=0, grid_size=201, units='ms')
    ...
    feed_low_cut = LogFloatProperty("09", 10.0, 500.0, decimals=0, grid_size=51, units='Hz')
    feed_l = LinearFloatProperty("10", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    feed_r = LinearFloatProperty("11", 0.0, 100.0, decimals=0, grid_size=51, units='%')
    feedback_high_cut = LogFloatProperty("12", 200.0, 20000.0, decimals=0, grid_size=51, units='Hz')
