...
class RichPlateReverbFxParams(MixerNode):
    ...
    size = LinearFloatProperty("03", 4.0, 39.0, decimals=0, grid_size=36, units='m')
    ...
    attack = LinearFloatProperty("11", 0.0, 100.0, decimals=0, grid_size=51)
    spin = LinearFloatProperty("12", 0.0, 100.0, decimals=0, grid_size=21, units='%')
    echo_left_delay = LinearFloatProperty("13", 0.0, 1200.0, decimals=0, grid_size=241, units='ms')
    echo_right_delay = LinearFloatProperty("14", 0.0, 1200.0, decimals=0, grid_size=241, units='ms')
    echo_left_feedback = LinearFloatProperty("15", -100.0, 100.0, decimals=0, grid_size=101, units='%')
    echo_right_feedback = LinearFloatProperty("16", -100.0, 100.0, decimals=0, grid_size=101, units='%')
