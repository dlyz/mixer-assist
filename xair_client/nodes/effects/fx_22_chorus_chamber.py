...
class ChorusChamberFxParams(MixerNode):
    ...
    chorus_speed = LogFloatProperty("01", 0.05, 4.0, decimals=2, grid_size=101, units='Hz')
    chorus_depth = LinearFloatProperty("02", 0.0, 100.0, decimals=0, grid_size=21, units='%')
    chorus_delay = LogFloatProperty("03", 0.5, 50.0, decimals=1, grid_size=51, units='ms')
    chorus_phase = LinearFloatProperty("04", 0.0, 180.0, decimals=0, grid_size=37, units='°')
    chorus_wave = LinearFloatProperty("05", 0.0, 100.0, decimals=0, grid_size=21, units='%')
