...
class DualXtecEq5FxParams(MixerNode):
    ...
    a_low_boost = LinearFloatProperty("04", 0.0, 10.0, decimals=1, grid_size=101)
    a_mid_frequency = EnumIntProperty("05", AMidFrequencyOptions)
    a_mid_cut = LinearFloatProperty("06", 0.0, 10.0, decimals=1, grid_size=101)
    a_high_frequency = EnumIntProperty("07", AHighFrequencyOptions)
    a_high_boost = LinearFloatProperty("08", 0.0, 10.0, decimals=1, grid_size=101)
    a_transfer = BoolProperty("09")
    b_on = BoolProperty("10")
    b_gain = LinearFloatProperty("11", -12.0, 12.0, decimals=1, grid_size=49, units='dB')
    b_low_frequency = EnumIntProperty("12", BLowFrequencyOptions)
    b_low_boost = LinearFloatProperty("13", 0.0, 10.0, decimals=1, grid_size=101)
    b_mid_frequency = EnumIntProperty("14", BMidFrequencyOptions)
    b_mid_cut = LinearFloatProperty("15", 0.0, 10.0, decimals=1, grid_size=101)
    b_high_frequency = EnumIntProperty("16", BHighFrequencyOptions)
    b_high_boost = LinearFloatProperty("17", 0.0, 10.0, decimals=1, grid_size=101)
